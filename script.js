...
// Função de quando clico no botão de Fechar Pedido
  function Checkout()
  {
    ...
    formattedText = ("Olá, gostaria de fazer o pedido: %0a- Prato: "+ dishName + " - Bebida: " + drinkName + " - Sobremesa: " + dessertName + " ------ Total:" + "R$ " + totalValue.replace('.',','));
  }
  ...
  function ConfirmCheckout()
  {
    ...
    window.open("https://wa.me/5551998788448?text=" + formattedText + " --- " + userName + " --- " + userAdress, "_blank");
